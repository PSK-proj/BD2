...
SELECT k.nazwa AS kwiaciarnia, EXTRACT(MONTH FROM f.data_sprzedazy) AS miesiac,
...
SELECT g.nazwa AS gatunek, EXTRACT(MONTH FROM f.data_sprzedazy) AS miesiac,
...
GROUP BY g.nazwa, EXTRACT(MONTH FROM f.data_sprzedazy);
