...
sqlldr %user%/%pass%@%instance% CONTROL=./Loader/dane_personalneadresy.ctl
...
sqlldr %user%/%pass%@%instance% CONTROL=./Loader/pozycja_paragonu_gatunek.ctl
sqlldr %user%/%pass%@%instance% CONTROL=./Loader/pozycja_paragonu_usluga.ctl
